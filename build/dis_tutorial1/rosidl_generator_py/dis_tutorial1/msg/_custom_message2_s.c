...
bool dis_tutorial1__msg__custom_message2__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("dis_tutorial1.msg._custom_message2.CustomMessage2", full_classname_dest, 49) == 0);
  }
  dis_tutorial1__msg__CustomMessage2 * ros_message = _ros_message;
  {  // text
...
{
  /* NOTE(esteve): Call constructor of CustomMessage2 */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("dis_tutorial1.msg._custom_message2");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "CustomMessage2");
