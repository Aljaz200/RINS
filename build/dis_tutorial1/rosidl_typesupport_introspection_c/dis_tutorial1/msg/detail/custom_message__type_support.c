...
static rosidl_typesupport_introspection_c__MessageMember dis_tutorial1__msg__CustomMessage__rosidl_typesupport_introspection_c__CustomMessage_message_member_array[2] = {
  {
    "content",  // name
