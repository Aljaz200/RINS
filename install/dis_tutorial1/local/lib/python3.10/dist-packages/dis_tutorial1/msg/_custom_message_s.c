...
bool dis_tutorial1__msg__custom_message__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("dis_tutorial1.msg._custom_message.CustomMessage", full_classname_dest, 47) == 0);
  }
  dis_tutorial1__msg__CustomMessage * ros_message = _ros_message;
  {  // content
...
PyObject * dis_tutorial1__msg__custom_message__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("dis_tutorial1.msg._custom_message");
