...
bool hwpub__msg__hwmsg__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("hwpub.msg._hwmsg.Hwmsg", full_classname_dest, 22) == 0);
  }
  hwpub__msg__Hwmsg * ros_message = _ros_message;
  {  // s
...
{
  /* NOTE(esteve): Call constructor of Hwmsg */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("hwpub.msg._hwmsg");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "Hwmsg");
